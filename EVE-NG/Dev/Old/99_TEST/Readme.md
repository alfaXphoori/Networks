...
| 🔢 ข้อที่ | 📝 รายการ | 🎯 คะแนน |
|--------|-----------|---------|
|1| เชื่อมต่อโครงสร้างเครือข่าย | 2 คะแนน |
|2| การตั้งค่า VLAN | 3 คะแนน |
|3| ตั้งค่า Inter-VLAN Routing | 4 คะแนน |
|4| การกำหนด Dynamic Routing | 5 คะแนน |
|5| คำนวณ Subnet และกำหนด IP Address | 3 คะแนน |
|6| การทดสอบการเชื่อมต่อเครือข่าย | 3 คะแนน |
|all| **รวมคะแนน** | **20 คะแนน** |

---
## 📋 รายชื่อนักศึกษาและ Routing Protocol 
📌 **การกำหนดค่าเครือข่ายสำหรับนักศึกษาแต่ละคน** 🖥️
- 🆔 **กำหนดเลขที่ของนักศึกษา (xx) ให้ตรงกับตารางรายชื่อ**
- 🌐 **ตัวอย่างการตั้งค่า:**
  - **| 1 | นายจักรี นาสีแสน | OSPF |**
  - **IP Address: 10.10.xx.11 → 10.10.1.11**
  - **VLAN: 1xx → VLAN 101**
