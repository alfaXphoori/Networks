...
📌 **ตั้งค่า Dynamic Routing Protocol (OSPF หรือ EIGRP) บน Router**  
...
### **5️⃣ การคำนวณ Subnet และการกำหนด IP Address (3 คะแนน)**

📌 **คำนวณและกำหนดหมายเลข IP Address ที่ถูกต้อง**  

- 🔢 **คำนวณ Subnet ให้เหมาะสมกับโครงสร้างเครือข่าย**  
...
- 🔹 **ภาพแคปหน้าจอของโครงสร้างเครือข่ายใน EVE-NG**  
...
---
## 📋 รายชื่อนักศึกษาและ Routing Protocol ที่กำหนด xx กำหนดให้เป็นเลขที่ของนักศึกษา
